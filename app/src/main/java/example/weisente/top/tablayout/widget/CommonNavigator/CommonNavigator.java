package example.weisente.top.tablayout.widget.CommonNavigator;
...
import example.weisente.top.tablayout.R;
import example.weisente.top.tablayout.widget.abs.CommonNavigatorAdapter;
import example.weisente.top.tablayout.widget.abs.IMeasurablePagerTitleView;
import example.weisente.top.tablayout.widget.abs.IPagerIndicator;
import example.weisente.top.tablayout.widget.abs.IPagerNavigator;
import example.weisente.top.tablayout.widget.abs.IPagerTitleView;
import example.weisente.top.tablayout.widget.helper.NavigatorHelper;
import example.weisente.top.tablayout.widget.helper.ScrollState;
import example.weisente.top.tablayout.widget.mode.PositionData;
